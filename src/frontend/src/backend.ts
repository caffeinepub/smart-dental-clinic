...
export class Backend implements backendInterface {
    ...
    async bookAppointment(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
    ...
    async getAppointmentByPhone(arg0: string): Promise<Appointment> {
        if (this.processError) {
            try {
                const result = await this.actor.getAppointmentByPhone(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
